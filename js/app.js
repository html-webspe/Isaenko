            ...
            document.addEventListener("click", function (e) {
                ...
                if (buttonOpen) {
                    ...
                    if ("error" !== this._dataValue) {
                        ...
                        this.open();
                        return;
                    } else this.modalLogging(`Ой ой, не заполнен атрибут у ${buttonOpen.classList}`);
                    return;
                }
        ...
        open(selectorValue) {
            if (bodyLockStatus) {
                ...
                if (this.targetOpen.element) {
                    ...
                    this.modalLogging(`Открыл попап`);
                } else this.modalLogging(`Ой ой, такого попапа нет.Проверьте корректность ввода. `);
            }
        }
        close(selectorValue) {
            ...
            this.modalLogging(`Закрыл попап`);
        }
        _getHash() {
            ...
            if (0 === error) {
                ...
                if (ajax) {
                    ...
                    if (response.ok) {
                        ...
                        formBtn.innerHTML = "Дякую! Ваше повідомлення відправлено";
